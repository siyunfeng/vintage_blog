...
function Carousel ({ featuredPosts }) {
    const posts = featuredPosts;
    return (<div id="featuredPosts" 
            ...
            <div className="carousel-inner">
                {posts.map((featuredPost, index) => {
                    const post = featuredPost.node;
                    if (index === 0) {
                        return (<div className="carousel-item align-center active" 
                            ...
                            <div className="carousel-caption mb-6 d-none d-md-block">
                                    ...
                                    <p className='inline-flex bg-white pl-6 p-2'>by {post.author.name}</p>
                                 </div>
                                </div>)
                    } else {
                        return (<div className="carousel-item align-center" 
